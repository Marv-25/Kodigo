...
public class BdEmpleados {
    ...
    public static List<Empleado> listarEmpleados (){
        ...
        Empleado empleado2 = new Empleado(159,"Mario","Rodriguez","mas","18-05-1993","activo",15,"MAESTRO","PO4581485","Historiador");
        ...
        Empleado empleado5 = new Empleado (162,"Israel","Mendez","fem","4-03-1875","inactivo",25,"MAESTRO","ASDRF4584","Administración");
        Empleado empleado6 = new Empleado (163,"Monica","Mendez","fem","4-03-1875","inactivo",26,"Analista compras","ASDRF4584","Administración");
        Empleado empleado7 = new Empleado (164,"Miriam","Mendez","fem","4-03-1875","inactivo",27,"MAESTRO","ASDRF4584","Administración");
        Empleado empleado8 = new Empleado (165,"Fernanda","Mendez","fem","4-03-1875","inactivo",28,"Analista compras","ASDRF4584","Administración");
        Empleado empleado9 = new Empleado (166,"Dimitri","Mendez","fem","4-03-1875","inactivo",29,"MAESTRO","ASDRF4584","Administración");
